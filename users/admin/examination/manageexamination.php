              ...
              <table id="tables" class="table table-bordered table-hover table-striped">
                <thead>
                  <tr>
                    ...
                    <th>Validity</th>
                    <th>Duration</th>
                    <th>AES key <small class="text-danger">(Encryption Key)</small></th>
                    <th>BlowFish Key <small class="text-danger">(Decryption Key)</small></th>
                    <th>Visibility</th>
                    <!-- <th>Camera</th> -->
                  ...
                  <div class="card card-info">
                    ...
                    <form class="form-horizontal" id="newexaminationform">
                      <div class="card-body">
                        ...
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">AES Encryption Key <small class="text-danger">(Same as decryption key)</small> </label>
                          <div class="col-sm-8">
