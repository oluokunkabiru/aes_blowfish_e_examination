...
--
-- Host: localhost
-- Generation Time: Jan 28, 2022 at 05:24 PM
...
INSERT INTO `school_information` (`id`, `name`, `logo`, `address`, `current_term`, `city`, `state`, `hostsystem`, `about`, `school_id`, `activation_key`, `last_update`) VALUES
(2, 'KOADIT INTERNATIONAL SCHOOL', '../images/oic.png', '1, Gurara Street, Off IBB Boulevard, Maitama', 'First term', 'Abuja', 'Federal Capital Territory', 'koadit pc', NULL, 'cfcd208495d565ef66e7dff9f98764da', '', '2022-01-28 16:24:19');
...
(1, 'admins', 'kabiru', 'adesina', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 1, 'admin', '2022-06-28 16:23:09', NULL, NULL, NULL, NULL, NULL),
