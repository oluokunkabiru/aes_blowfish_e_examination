...
protected $serverpassword = ''; 
 protected $dbname = 'eas_blowfish_e_exam'; 
...
private function AESDecryption($message, $key)
{
...
public function makeAES($msg, $key)
{
    // $request->validate([
    ...
    // ]);
    $output = $this->AESEncrypt($msg, $key);
    return $output;
...
public function DecyptAES($msg, $key)
{
    ...
    $output = $this->AESDecryption($msg, $this->authorizeKey($key));
    return $output;
